    ...
    workloads: [
      {
        ...
        body: "Verification, coverage checks, and record requests handled before the visit.",
      },
      {
        title: "Prior authorization",
        body: "Packet assembly, submission, and status chasing with clinician review gates.",
      },
      {
        title: "Revenue cycle",
        body: "Coding validation, denial classification, and appeal drafting.",
      },
      {
        title: "Care coordination",
        body: "Referral tracking and follow-up outreach with escalation to staff.",
      },
    ],
    compliance: [
      "HIPAA-aligned architecture",
      "BAAs with all subprocessors",
      "PHI redaction in transit",
      "Full audit logging",
    ],
    proof: [
    ...
    workloads: [
      {
        ...
        body: "Document collection, KYC checks, and risk scoring with reviewer sign-off.",
      },
      {
        title: "Reconciliation",
        body: "Daily multi-source matching with exception queues and aging.",
      },
      {
        title: "Surveillance support",
        body: "Communication review triage that ranks by risk, not by date.",
      },
      {
        title: "Reporting automation",
        body: "Regulatory and client reporting generated from a governed warehouse.",
      },
    ],
    compliance: [
    ...
    workloads: [
      {
        ...
        body: "Onboarding instrumentation with targeted in-product and outbound nudges.",
      },
      {
        title: "Support automation",
        body: "Tier-1 resolution with product-aware retrieval and clean escalation.",
      },
      {
        title: "Expansion signals",
        body: "Usage-based playbooks routed to the right owner at the right moment.",
      },
      {
        title: "Churn prediction",
        body: "Leading-indicator models with a defined intervention for each risk tier.",
      },
    ],
    compliance: [
    ...
    workloads: [
      {
        ...
        body: "Quote comparison, PO matching, and delivery exception handling.",
      },
      {
        title: "Quality intelligence",
        body: "Inspection data classified with defect trend alerts to engineering.",
      },
      {
        title: "Maintenance planning",
        body: "Condition signals converted into scheduled work orders.",
      },
      {
        title: "Documentation automation",
        body: "Work instructions and change records generated from source data.",
      },
    ],
    compliance: [
      "ISO 9001 documentation support",
      "Traceability by lot and serial",
    ...
    workloads: [
      {
        ...
        body: "Attribute extraction, copy generation, and image QA at SKU scale.",
      },
      {
        title: "Pricing intelligence",
        body: "Competitor and elasticity signals surfaced with guardrailed recommendations.",
      },
      {
        title: "Service automation",
        body: "Order status, returns, and WISMO resolved without an agent.",
      },
      {
        title: "Returns analysis",
        body: "Reason classification feeding merchandising and supplier scorecards.",
      },
    ],
    compliance: [
    ...
    workloads: [
      {
        ...
        body: "Multi-carrier status normalized with proactive delay alerts.",
      },
      {
        title: "Document processing",
        body: "BOL, invoice, and customs paperwork extracted and validated.",
      },
      {
        title: "Carrier scorecards",
        body: "Performance and cost analytics that inform the next tender.",
      },
      {
        title: "Claims automation",
        body: "Evidence assembly and submission with status tracking.",
      },
    ],
    compliance: [
      "Customs documentation accuracy controls",
