...
export const caseStudies: CaseStudy[] = [
  ...
  },
  {
    ...
    legacyWorkflow: [
      { step: "Data extraction", detail: "Manual CSV exports from Google Ads, Meta Ads, and GA4", cost: "5 hrs/week" },
      { step: "CRM data sync", detail: "Pulling lead status and revenue values from HubSpot/Salesforce", cost: "3 hrs/week" },
      { step: "Data consolidation", detail: "Merging sheets, adjusting timezones, and currency alignment", cost: "3 hrs/week" },
      { step: "Report assembly", detail: "Designing and copy-pasting charts into Google Slides decks", cost: "2 hrs/week" },
    ],
    solution:
    ...
    solutionPillars: [
      { title: "API-first ingestion", body: "Direct native API connections to all major ad networks and CRM platforms." },
      { title: "Automated QA checks", body: "Data validations verifying spend, impression counts, and conversion metrics." },
      { title: "Dynamic dashboards", body: "Interactive client portals replacing static PDF reports entirely." },
      { title: "Scheduled delivery", body: "Automated dispatch of customized summaries via Slack and Email." },
    ],
    architecture: {
      layers: [
        { name: "Ad APIs", nodes: ["Google Ads", "Meta Ads", "TikTok Ads", "GA4"] },
        { name: "Pipeline", nodes: ["Fivetran ingestion", "BigQuery", "dbt transformations"] },
        { name: "Core", nodes: ["Currency converter", "QA checker", "Looker Studio API", "Email dispatch"] },
    ...
    timeline: [
      { phase: "Audit & schema design", duration: "Weeks 1–2", detail: "Mapped client data structures and ad platform APIs." },
      { phase: "Pipeline build", duration: "Weeks 3–6", detail: "API connections, warehouse ingestion, and clean data modeling." },
      { phase: "Reporting engine", duration: "Weeks 7–9", detail: "Dashboard template creation, automated PDF compilation." },
      { phase: "QA & alerting", duration: "Weeks 10–11", detail: "Configured automated validation checks and notification routes." },
      { phase: "Production rollout", duration: "Weeks 12–13", detail: "Gradual onboarding of clients, team training, handover." },
    ],
    roi: [
